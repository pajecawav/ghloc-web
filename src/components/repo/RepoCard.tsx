...
export const RepoCard = ({ repo }: Props) => {
	return (
		...
		>
			<a className="min-h-[8rem] flex flex-col gap-1 border border-normal-border rounded-md px-4 py-2 transition-colors duration-100 !outline-none hover:border-active-border focus:border-active-border">
				...
				<div className="text-xs text-normal-text">
					Updated {dayjs(repo.updated_at).fromNow()}
				</div>

				<div className="flex items-center gap-2 text-sm text-normal-text">
					{repo.language && (
