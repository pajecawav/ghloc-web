...
export const RepoCard = ({ repo }: Props) => {
	return (
		<Link
			...
			className="min-h-[8rem] flex flex-col gap-1 border border-normal rounded-md px-4 py-2 transition-colors duration-100 !outline-none hover:border-active focus:border-active"
		>
